...
var box_thickness = 0.01;
for(var i = 0; i < 4; i ++)
{
  var geometry = new THREE.BoxGeometry(box_thickness,box_width*2, box_width*2);
...
{
  scaling = 0.001;
  cones[0].rotateY(delta_time * scaling / rotation_periods[0]);
  cones[1].rotateY(delta_time * scaling / rotation_periods[1]);
  cones[2].rotateY(delta_time * scaling / rotation_periods[2]);
  cones[3].rotateY(delta_time * scaling / rotation_periods[3]);
}
